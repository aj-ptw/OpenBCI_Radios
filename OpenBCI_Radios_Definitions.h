...
// Max buffer lengths
#define OPENBCI_BUFFER_LENGTH_MULTI 512

// Number of buffers
#define OPENBCI_NUMBER_RADIO_BUFFERS 1
#define OPENBCI_NUMBER_SERIAL_BUFFERS 16
#define OPENBCI_NUMBER_STREAM_BUFFERS 30 // This should be at least one greater than poll time divided by packet interval to allow for the ack counter.
